  ...
  return (
    <div className="navbar flex flex-col gap-5 mb-2 py-4 items-center justify-between border-1 rounded-2xl text-white px-2 ">
      <div className="logo-container flex flex-col">
        <div className="logo flex flex-col w-14 h-14 m-4 mt-2 object-contain">
        ...
        <div className="flex items-center relative group">
          <div
            className={clsx(
              ...
              "nav-item transition-all ease-in-out group-hover:scale-110 group-hover:bg-white items-center justify-center b rounded-full p-2 dashboard flex flex-col"
            )}
          >
            <a href="/lobby">
              <img
                className="w-8 h-8"
                src="/assets/navbar/homeIcon.png"
                alt=""
              />
            </a>
          </div>
          <span
            className={clsx(
              "text-2xl font-bold absolute transition duration-300 ease-linear opacity-0 group-hover:opacity-100 group-hover:translate-x-24",
              currentPath === "lobby"
        ...
        <div className="flex items-center relative group">
          ...
          >
            <a href="/lobby/profile">
              <img
                className="w-8 h-8"
                src="/assets/navbar/profileIcon.png"
                alt=""
              />
            </a>
          </div>
        ...
        <div className="flex items-center relative group">
          ...
          >
            <a href="/lobby/leaderboard">
              <img
                className="w-8 h-8"
                src="/assets/navbar/leaderboardIcon.png"
                alt=""
              />
            </a>
          </div>
        ...
        <div className="flex items-center relative group">
          ...
          >
            <a href="/lobby/team">
              <img
                className="w-8 h-8"
                src="/assets/navbar/teamIcon.png"
                alt=""
              />
            </a>
          </div>
          ...
          <div className="nav-item transition-all ease-in-out hover:scale-110 group-hover:bg-white items-center justify-center b rounded-full p-2 logout-container flex flex-col">
            <div className="logout flex flex-col">
              <button onClick={handleLogout}>
                <img
                  className="w-8 h-8"
                  src="/assets/navbar/logoutIcon.png"
                  alt=""
                />
              </button>
            </div>
